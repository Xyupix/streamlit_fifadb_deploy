...
st.sidebar.markdown("Developed by Igor Emídio")
st.link_button("Go to Kaggle Dataset", "https://www.kaggle.com/datasets/kevwesophia/fifa23-official-datasetclean-data?resource=download")
st.write("""
